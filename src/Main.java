...
public class Main {
    public static void main(String[] args) {
        ...
        final double stochasticConstant = 0.8;   // This determines how much influence probability vector has
        ...
        for (int trial = 1; trial <= 1000000; ++trial) {         // Makes 800000 trials
            ...
            double tempDiff = startLineValues[robot.sequence.get(0).cell.x] * (score > avgScoreForNonzeroTrials ? (startLineValues[robot.sequence.get(0).cell.x] > totalStartLineValue/5 ? 0 : 0.8) : (startLineValues[robot.sequence.get(0).cell.x] > 0.2 ? -0.00005 : 0));
